...
export default function BetterFanPage() {
  ...
  const rounds = [
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598786/betterfan2_ik1opp.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598786/betterfan3_cejtar.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598787/betterfan4_rou6kd.jpg",
      winners: 5,
      description: "Complete the Game Economy Design puzzle with correct answers",
      color: "from-emerald-500 to-green-600",
      showRoundNumber: false,
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/20 via-green-900/20 to-emerald-900/20" />
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% { box-shadow: 0 0 40px rgba(16, 185, 129, 0.8), 0 0 60px rgba(16, 185, 129, 0.6); }
        }
        @keyframes slideInUp {
      ...
      <div className="relative z-10">
        {/* Header */}
        <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-emerald-500/20">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-emerald-400 via-green-500 to-emerald-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-emerald-400 via-green-500 to-emerald-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">Better Fan</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • April 28, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-emerald-900/50 to-green-900/50 border-emerald-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">April 29, 2024</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-green-900/50 to-emerald-900/50 border-green-500/30 animate-fadeInScale"
                ...
                <Card
                  className="bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border-emerald-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-emerald-400">$BFF Tokens</p>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-emerald-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  ...
                  <span className="text-emerald-400 font-bold">Better Fan</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-emerald-400 font-bold">4 rounds</span>. In each
                    ...
                    <p className="text-lg font-bold text-emerald-400">
                      20 total winners to get $10 each in $BFF tokens.
                    </p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-red-500/10 to-emerald-500/10 border border-red-500/30 rounded-lg p-6">
                  <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-emerald-400 font-mono">#L2EBetterFan</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-emerald-500/30 overflow-hidden animate-slideInUp"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $BFF</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-emerald-500 ml-4">
                                  <p className="text-emerald-400 font-mono">Your answer</p>
                                  <p className="text-emerald-400 font-mono">Hashtag #L2EBetterFan</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-green-500 ml-4">
                                  ...
                                  <p className="text-green-400 font-mono">Hashtag #L2EBetterFan</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the "Game Economy Design" on the Twitter post (X.com/Betterfanapp)</p>
                                <p>
                                ...
                                <p>3️⃣ Put your Telegram Username and hashtag #L2EBetterFan on the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $BFF!
                          </p>
                        </div>
                      </div>
        ...
        {/* Footer */}
        <footer className="py-12 px-4 border-t border-emerald-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 7.png" alt="Better Fan L2E" className="h-8 w-8 rounded" />
              <h3 className="text-2xl font-bold bg-gradient-to-r from-emerald-400 to-green-500 bg-clip-text text-transparent">
