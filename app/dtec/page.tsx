...
export default function DTECPage() {
  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598791/dtec1_wccsvr.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $DTEC tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598791/dtec2_au7yzk.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598791/dtec3_vhees4.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598792/dtec4_qjmtqf.jpg",
      winners: 5,
      description: "Download and complete the blank column with correct answers",
      color: "from-orange-500 to-red-600",
      showRoundNumber: false,
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-orange-400 via-red-500 to-orange-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-orange-400 via-red-500 to-orange-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">DTEC</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • July 25, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-orange-900/50 to-red-900/50 border-orange-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">July 27, 2024</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-red-900/50 to-orange-900/50 border-red-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-red-400">@openpad_official</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    <Gift className="h-8 w-8 text-orange-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Reward</h3>
                    <p className="text-sm text-gray-300">$200 worth</p>
                    <p className="text-sm text-orange-400">$DTEC Tokens</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    <Timer className="h-8 w-8 text-red-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Duration</h3>
                    <p className="text-sm text-gray-300">2 Hours</p>
                    <p className="text-sm text-red-400">Extended Session</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-orange-500/30 animate-slideInUp">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session for <span className="text-orange-400 font-bold">DTEC</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-orange-400 font-bold">4 rounds</span>. In each
                    ...
                    <p className="text-lg font-bold text-orange-400">
                      20 total winners to get $10 each in $DTEC tokens.
                    </p>
                  </div>
                  ...
                  <div className="mt-6 space-y-2">
                    <div className="flex items-center gap-2 text-red-400">
                      ...
                      <span className="font-bold">ROUND 1: THE CHOICE CHALLENGE</span>
                    </div>
                    <div className="flex items-center gap-2 text-red-400">
                      <AlertTriangle className="h-5 w-5" />
                      <span className="font-bold">ROUND 2: PUZZLE SCRAMBLE</span>
                    </div>
                    <div className="flex items-center gap-2 text-red-400">
                      <AlertTriangle className="h-5 w-5" />
                      <span className="font-bold">ROUND 3: RIDDLE RESOLVER</span>
                    </div>
                    <div className="flex items-center gap-2 text-red-400">
                      <AlertTriangle className="h-5 w-5" />
                      <span className="font-bold">ROUND 4: COMPLETE THE PUZZLE</span>
                    </div>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-orange-400 font-mono">#L2EDTEC</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-orange-500/30 overflow-hidden animate-slideInUp"
                ...
                >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            <div className="flex items-center gap-2 text-green-400">
                              ...
                              <span className="font-bold text-sm">Random Winners</span>
                            </div>
                            <span className="text-green-400 text-sm">$10 each in $DTEC</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-orange-500 ml-4">
                                  ...
                                  <p className="text-orange-400 font-mono">Hashtag #L2EDTEC</p>
                                </div>
                            ...
                            {round.id === 2 && (
                              <>
                                ...
                                <p>2️⃣ After group unmute you can submit the answer with format:</p>
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-red-500 ml-4">
                                  <p className="text-red-400 font-mono">Your answer</p>
                                  <p className="text-red-400 font-mono">Hashtag #L2EDTEC</p>
                                </div>
                                <p>3️⃣ Give a reaction to each question</p>
                              </>
                            )}
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Download the image and complete the blank column with the correct answer</p>
                                <p>2️⃣ Put your Telegram Username and hashtag #L2EDTEC on the RED BOX</p>
                              </>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The winners are selected randomly by the team for $10 in $DTEC!
                          </p>
                        </div>
                      </div>
                    ...
                    {round.id === 4 && (
                      <div className="mt-8 space-y-4">
                        <h4 className="text-xl font-bold text-white mb-4">Question:</h4>
                        <Card className="bg-gray-800/50 border-gray-600/30 p-6 text-center">
                          <div className="w-full h-64 bg-gray-700/50 rounded border-2 border-dashed border-gray-600 flex items-center justify-center">
                            <p className="text-gray-500 text-lg">(foto disini)</p>
                          </div>
                        </Card>
                      </div>
                    )}
        ...
        <footer className="py-12 px-4 border-t border-orange-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 10.png" alt="DTEC L2E" className="h-8 w-8 rounded" />
