...
export default function PlenaFinancePage() {
  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785559328/plena1_kt5dcz.png",
      winners: 5,
      description: "Answer the multiple-choice questions correctly to win $10 in $PLENA tokens.",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785559327/plena2_p4d0jo.png",
      winners: 5,
      description: "Unscramble the words in the image to win $10 in $PLENA tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785559328/plena3_lfoemc.png",
      winners: 10,
      description: "Find answers on plena website and fill in the blanks",
    ...
    },
    {
      ...
      icon: <Search className="h-8 w-8" />,
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785560667/20260801_120357_oda4c6.jpg",
      winners: 10,
      description: "Complete the tokenomics $PLENA",
      color: "from-pink-500 to-red-600",
      showRoundNumber: false,
      questions: [],
    },
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 1.png" alt="Plena Finance L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>
              ...
              <h2 className="text-xl md:text-3xl font-bold mb-6 text-white">Plena Finance</h2>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Muhamad Novreysa • February 28, 2024</p>
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">March 3, 2024</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-pink-400">$PLENA Tokens</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">Interactive</p>
                    <p className="text-sm text-green-400">Session</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-blue-500/30 animate-slideInUp">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  ...
                  <span className="text-blue-400 font-bold">Plena Network</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-blue-400 font-bold">3 rounds</span>. In each round,
                    ...
                    <p className="text-lg font-bold text-blue-400">
                      20 total winners to get $10 each in $PLENA tokens.
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-blue-400 font-mono">#L2EPLENA</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300">3 Exciting Rounds Await You</p>
            </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $PLENA</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <p>2️⃣ Send your answer and input your Telegram Username with the hashtag:</p>
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-blue-500 ml-4">
                                  ...
                                  <p className="text-blue-400 font-mono">Your Telegram Username</p>
                                  <p className="text-blue-400 font-mono">Hashtag #L2EPLENA</p>
                                </div>
                            ...
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Your Telegram Username</p>
                                  <p className="text-purple-400 font-mono">Hashtag #L2EPLENA</p>
                                </div>
                                <p>3️⃣ Give a reaction to each question </p>
                            ...
                            {round.id === 3 && (
                              <>
                                <p className="font-bold text-white mb-2">Question 1: TOKENOMICS</p>
                                <p>1️⃣ In this round you can get answers on the plena website</p>
                                <p>
                                  2️⃣ Write the correct answer to fill in the blank on the dotted line
                                </p>
                                <p>3️⃣ After group unmute you can submit the answer with format:</p>
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  <p className="text-purple-400 font-mono">Your answer</p>
                                  <p className="text-purple-400 font-mono">Your Telegram Username</p>
                                  <p className="text-purple-400 font-mono">Hashtag #L2EPLENA</p>
                                </div>
                              <p>4️⃣ Give a reaction to each question </p>
                            ...
                            {round.id === 4 && (
                              <>
                                <p className="font-bold text-white mb-2">Question 1: TOKENOMICS</p>
                                <p>1️⃣ Check out the Token Allocation PLENA on the OpenPad Channel</p>
                                <p>
                                  2️⃣ Download the image and edit by correctly writing the allocation inside the table
                                  chart including the total allocation
                                </p>
                                <p>3️⃣ Put your Telegram Username and hashtag #L2EPLENA on the BLUE BOX</p>
                                <p>4️⃣ Send the image with your correct answer</p>
                              </>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $PLENA!
                          </p>
                        </div>
                      </div>
        ...
        <footer className="py-12 px-4 border-t border-blue-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 1.png" alt="Plena Finance L2E" className="h-8 w-8 rounded" />
