...
export default function SugarKingdomPage() {
  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785596506/sko1_mydmko.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $SUGAR tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785596506/sko2_t31kuk.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785596506/sko3_dylvas.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785596506/sko4_kh0sku.jpg",
      winners: 5,
      description: "Complete the Sugar Kingdom structure puzzle with correct answers",
      color: "from-pink-500 to-purple-600",
      showRoundNumber: false,
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-pink-900/20 via-purple-900/20 to-pink-900/20" />
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% { box-shadow: 0 0 40px rgba(236, 72, 153, 0.8), 0 0 60px rgba(236, 72, 153, 0.6); }
        }
        @keyframes slideInUp {
      ...
      <div className="relative z-10">
        {/* Header */}
        <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-pink-500/20">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 4.png" alt="Sugar Kingdom L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-pink-400 via-purple-500 to-pink-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-pink-400 via-purple-500 to-pink-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">Sugar Kingdom</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • March 15, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-pink-900/50 to-purple-900/50 border-pink-500/30 animate-fadeInScale"
                  style={{ animationDelay: "0.2s" }}
                >
                  <CardContent className="p-6 text-center">
                    <Clock className="h-8 w-8 text-pink-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Time</h3>
                    <p className="text-sm text-gray-300">10:00 AM UTC</p>
                    <p className="text-sm text-gray-300">March 18, 2024</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-pink-400">$SUGAR Tokens</p>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-pink-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  ...
                  <span className="text-pink-400 font-bold">Sugar Kingdom</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-pink-400 font-bold">4 rounds</span>. In each round,
                    ...
                    <p className="text-lg font-bold text-pink-400">
                      20 total winners to get $10 each in $SUGAR tokens.
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-pink-400 font-mono">#L2ESugarKingdom</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-pink-500/30 overflow-hidden animate-slideInUp"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $SUGAR</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-500/30 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-pink-500 ml-4">
                                  ...
                                  <p className="text-pink-400 font-mono">Hashtag #L2ESugarKingdom</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Hashtag #L2ESugarKingdom</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the structure SETBACKS FOR Sugar Kingdom on the Gitbook Sugar Kingdom</p>
                                <p>2️⃣ Download the image and write your correct answer above the RED ARROW</p>
                                <p>3️⃣ Enter your Telegram username and hashtag #L2ESugarKingdom in the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $SUGAR!
                          </p>
                        </div>
                      </div>

                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-pink-500/30 animate-float">
                          <img
        ...
        {/* Footer */}
        <footer className="py-12 px-4 border-t border-pink-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 4.png" alt="Sugar Kingdom L2E" className="h-8 w-8 rounded" />
