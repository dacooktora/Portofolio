...
export default function OrangeDXPage() {
  ...
  const rounds = [
    {
      ...
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $O4DX tokens",
    ...
    },
    {
      ...
      winners: 5,
      description: "Complete the BRC20 structure puzzle with correct answers",
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 3.png" alt="OrangeDX L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-orange-400 via-yellow-500 to-orange-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-orange-400 via-yellow-500 to-orange-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">OrangeDX</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • March 11, 2024</p>
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">March 14, 2024</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-orange-400">$O4DX Tokens</p>
                  </CardContent>
                </Card>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-orange-500/30 animate-slideInUp">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session 2 for <span className="text-orange-400 font-bold">OrangeDX</span>
                  !
                </p>
                ...
                <div className="bg-gradient-to-r from-orange-500/10 to-yellow-500/10 border border-orange-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    ...
                    <p className="text-lg font-bold text-orange-400">
                      20 total winners to get $10 each in $O4DX tokens.
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-orange-400 font-mono">#L2EOrangeDX</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $O4DX</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                            ...
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-orange-500 ml-4">
                                  ...
                                  <p className="text-orange-400 font-mono">Hashtag #L2EOrangeDX</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Hashtag #L2EOrangeDX</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-pink-500 ml-4">
                                  ...
                                  <p className="text-pink-400 font-mono">Hashtag #L2EOrangeDX</p>
                                </div>
                              </>
                            )}
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the structure SETBACKS FOR BRC20 on the Gitbook OrangeDX</p>
                                <p>2️⃣ Download the image and write your correct answer above the RED ARROW</p>
                                <p>3️⃣ Enter your Telegram username and hashtag #L2EOrangeDX in the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $O4DX!
                          </p>
                        </div>
                      </div>
        ...
        <footer className="py-12 px-4 border-t border-orange-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 3.png" alt="OrangeDX L2E" className="h-8 w-8 rounded" />
