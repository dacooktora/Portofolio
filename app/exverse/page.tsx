...
export default function ExversePage() {
  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598712/exverse1_ftbuwp.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $EXV tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598712/exverse2_cf7e8p.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598712/exverse3_m28utm.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598712/exverse4_xj8zci.jpg",
      winners: 5,
      description: "Complete the Exverse structure puzzle with correct answers",
      color: "from-indigo-500 to-purple-600",
      showRoundNumber: false,
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 6.png" alt="Exverse L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-purple-400 via-indigo-500 to-purple-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-indigo-500 to-purple-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">Exverse</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • March 25, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-purple-900/50 to-indigo-900/50 border-purple-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">March 28, 2024</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-indigo-900/50 to-purple-900/50 border-indigo-500/30 animate-fade InScale"
                  style={{ animationDelay: "0.4s" }}
                >
                  <CardContent className="p-6 text-center">
                    <MapPin className="h-8 w-8 text-indigo-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Venue</h3>
                    <p className="text-sm text-gray-300">Telegram Group</p>
                    <p className="text-sm text-indigo-400">@openpad_official</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-purple-400">$EXV Tokens</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    <Timer className="h-8 w-8 text-indigo-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Duration</h3>
                    <p className="text-sm text-gray-300">1 Hour</p>
                    <p className="text-sm text-indigo-400">Interactive Session</p>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-purple-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session 2 for <span className="text-purple-400 font-bold">Exverse</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-purple-400 font-bold">4 rounds</span>. In each
                    ...
                    <p className="text-lg font-bold text-purple-400">
                      20 total winners to get $10 each in $EXV tokens.
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-purple-400 font-mono">#L2EExverse</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-purple-500/30 overflow-hidden animate-slideInUp"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $EXV</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Hashtag #L2EExverse</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-indigo-500 ml-4">
                                  ...
                                  <p className="text-indigo-400 font-mono">Hashtag #L2EExverse</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the structure SETBACKS FOR Exverse on the Gitbook Exverse</p>
                                <p>2️⃣ Download the image and write your correct answer above the RED ARROW</p>
                                <p>3️⃣ Enter your Telegram username and hashtag #L2EExverse in the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $EXV!
                          </p>
                        </div>
                      </div>

                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-purple-500/30 animate-float">
                          <img
        ...
        <footer className="py-12 px-4 border-t border-purple-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 6.png" alt="Exverse L2E" className="h-8 w-8 rounded" />
            ...
            <Link href="/">
              <Button className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white px-8 py-3">
