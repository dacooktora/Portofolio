  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598788/midle1_n2tphc.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $MIDLE tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598789/midle2_whf4ih.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598789/midle3_qoyqah.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598790/midle4_aakkxc.jpg",
      winners: 5,
      description: "Complete the Midle project puzzle with correct answers",
      color: "from-teal-500 to-green-600",
      showRoundNumber: false,
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-900/20 via-green-900/20 to-teal-900/20" />
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% { box-shadow: 0 0 40px rgba(20, 184, 166, 0.8), 0 0 60px rgba(20, 184, 166, 0.6); }
        }
        @keyframes slideInUp {
      ...
      <div className="relative z-10">
        {/* Header */}
        <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-teal-500/20">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 9.png" alt="Midle L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>
              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-teal-400 via-green-500 to-teal-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-teal-400 via-green-500 to-teal-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">Midle</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • May 20, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-teal-900/50 to-green-900/50 border-teal-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">May 23, 2024</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-green-400">@openpad_official</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-teal-900/50 to-emerald-900/50 border-teal-500/30 animate-fadeInScale"
                  style={{ animationDelay: "0.6s" }}
                >
                  <CardContent className="p-6 text-center">
                    <Gift className="h-8 w-8 text-teal-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Reward</h3>
                    <p className="text-sm text-gray-300">$200 worth</p>
                    <p className="text-sm text-teal-400">$MIDLE Tokens</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-green-400">Interactive Session</p>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-teal-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session 2 for <span className="text-teal-400 font-bold">Midle</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-teal-500/10 to-green-500/10 border border-teal-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-teal-400 font-bold">4 rounds</span>. In each round,
                    ...
                    <p className="text-lg font-bold text-teal-400">
                      20 total winners to get $10 each in $MIDLE tokens.
                    </p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-red-500/10 to-teal-500/10 border border-red-500/30 rounded-lg p-6">
                  <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-teal-400 font-mono">#L2EMidle</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-teal-400 to-green-500 bg-clip-text text-transparent">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-teal-500/30 overflow-hidden animate-slideInUp"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          {round.showRoundNumber && (
                            <Badge className="mb-2 bg-teal-500/20 text-teal-400 border-teal-500/30">
                              ROUND {round.id}
                            </Badge>
                          )}
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $MIDLE</span>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-teal-500 ml-4">
                                  <p className="text-teal-400 font-mono">Your answer</p>
                                  <p className="text-teal-400 font-mono">Hashtag #L2EMidle</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <p>2️⃣ After group unmute you can submit the answer with format:</p>
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-green-500 ml-4">
                                  <p className="text-green-400 font-mono">Your answer</p>
                                  <p className="text-green-400 font-mono">Hashtag #L2EMidle</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Find answers on https://openpad.io/app/projects/midle</p>
                                <p>
                                  2️⃣ Download the image and edit the image by writing the correct answer to fill in each
                                  PURPLE BOX
                                </p>
                                <p>3️⃣ Put your Telegram Username and hashtag #L2EMidle on the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            {round.id === 1 || round.id === 2
                              ? "🎁 The fastest and correct answer will win $10 in $MIDLE!"
                              : "🎁 The winners are selected randomly by the team for $10 in $MIDLE!"}
                          </p>
                        </div>
                      </div>

                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-teal-500/30 animate-float">
        ...
        {/* Footer */}
        <footer className="py-12 px-4 border-t border-teal-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 9.png" alt="Midle L2E" className="h-8 w-8 rounded" />
              <h3 className="text-2xl font-bold bg-gradient-to-r from-teal-400 to-green-500 bg-clip-text text-transparent">
                Good Luck to All Participants!
              </h3>
            </div>
            <p className="text-gray-400 mb-6">May the fastest and smartest win! 🚀</p>
            <Link href="/">
              <Button className="bg-gradient-to-r from-teal-500 to-green-600 hover:from-teal-600 hover:to-green-700 text-white px-8 py-3">
