  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598792/og1_htkfpe.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598792/og2_bk3zei.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598793/og3_dqrixq.jpg",
      winners: 5,
        ...
        <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-purple-500/20">
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">{/* Empty space */}</div>
            </div>
          </div>
        </header>
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 12.png" alt="0G Foundation L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-purple-400 via-blue-400 to-purple-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-blue-400 to-purple-600 bg-clip-text text-transparent">
                Sessions 2
              </h2>
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-white">0G Foundation</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • November 11, 2024</p>

              {/* Event Details */}
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                <Card
                  className="bg-gradient-to-br from-purple-900/50 to-blue-900/50 border-purple-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">November 11, 2024</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-blue-400">@openpad_official</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-purple-400">USDT</p>
                  </CardContent>
                </Card>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-purple-500/30 animate-slideInUp">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session 2 for <span className="text-purple-400 font-bold">0G Foundation</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    ...
                    <p className="text-lg font-bold text-purple-400">
                      20 total winners to get $10 each in USDT.
                    </p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-red-500/10 to-purple-500/10 border border-red-500/30 rounded-lg p-6">
                  <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-purple-400 font-mono">#L2E0GFoundation</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in USDT</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Hashtag #L2E0GFoundation</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-blue-500 ml-4">
                                  ...
                                  <p className="text-blue-400 font-mono">Hashtag #L2E0GFoundation</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                            ...
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Find the correct answer</p>
                                <p>2️⃣ Download the image and edit the image by writing the correct answer</p>
                                <p>3️⃣ Put your Telegram Username and hashtag #L2E0GFoundation</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in USDT!
                          </p>
                        </div>
                      </div>
        ...
        <footer className="py-12 px-4 border-t border-purple-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 12.png" alt="0G Foundation L2E" className="h-8 w-8 rounded" />
            ...
            <Link href="/">
              <Button className="bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white px-8 py-3">
