...
export default function RGamesPage() {
  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785574655/rgames_1_azfp37.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $RGAME tokens",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785574656/rgames_2_erc4fe.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785574654/rgames_3_gqeobe.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785574654/rgames_4_ebw2ly.jpg",
      winners: 5,
      description: "Complete the IN-GAME ECONOMY structure puzzle",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/20 via-teal-900/20 to-blue-900/20" />
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 2.png" alt="R Games L2E" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-green-400 via-teal-500 to-blue-600 bg-clip-text text-transparent">
                Learn To Learn
              </h1>
              <h2 className="text-xl md:text-3xl font-bold mb-6 text-white">R Games</h2>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Muhammad Novreysa • March 7, 2024</p>
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">March 9, 2024</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-teal-900/50 to-cyan-900/50 border-teal-500/30 animate-fadeInScale"
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-teal-400">@openpad_official</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    <Gift className="h-8 w-8 text-cyan-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Reward</h3>
                    <p className="text-sm text-gray-300">$200 worth</p>
                    <p className="text-sm text-cyan-400">$RGAME Tokens</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-blue-400">Interactive Session</p>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-green-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session 2 for <span className="text-green-400 font-bold">R GAMES</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-green-500/10 to-teal-500/10 border border-green-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-green-400 font-bold">4 rounds</span>. In each
                    ...
                    <p className="text-lg font-bold text-green-400">
                      20 total winners to get $10 each in $RGAME tokens.
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-green-400 font-mono">#L2ERGAMES</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        To ensure fair distribution of rewards, each user can only win once for the entire flash-mini
                        game.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-green-500/30 overflow-hidden animate-slideInUp"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $RGAME</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                            ...
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-green-500 ml-4">
                                  ...
                                  <p className="text-green-400 font-mono">Your Telegram Username</p>
                                  <p className="text-green-400 font-mono">Hashtag #L2ERGAMES</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-teal-500 ml-4">
                                  ...
                                  <p className="text-teal-400 font-mono">Your Telegram Username</p>
                                  <p className="text-teal-400 font-mono">Hashtag #L2ERGAMES</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-cyan-500 ml-4">
                                  ...
                                  <p className="text-cyan-400 font-mono">Your Telegram Username</p>
                                  <p className="text-cyan-400 font-mono">Hashtag #L2ERGAMES</p>
                                </div>
                              </>
                            )}
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the structure IN-GAME ECONOMY on the Gitbook R Games</p>
                                <p>2️⃣ Download the image and write your correct answer above the RED ARROW</p>
                                <p>3️⃣ Enter your Telegram username and hashtag #L2EPRGAMES in the RED BOX</p>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The fastest and correct answer will win $10 in $RGAME!
                          </p>
                        </div>
                      </div>

                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-green-500/30 animate-float">
                          <img
        ...
        <footer className="py-12 px-4 border-t border-green-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 2.png" alt="R Games L2E" className="h-8 w-8 rounded" />
