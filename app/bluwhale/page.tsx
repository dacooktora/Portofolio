        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">
                BluWhale
              </h2>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • November 2024</p>
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">Nov 11, 18, 26</p>
                  </CardContent>
                </Card>

                <Card
                  className="bg-gradient-to-br from-cyan-900/50 to-teal-900/50 border-cyan-500/30 animate-fadeInScale"
                ...
                <Card
                  className="bg-gradient-to-br from-teal-900/50 to-blue-900/50 border-teal-500/30 animate-fadeInScale"
                  style={{ animationDelay: "0.6s" }}
                >
                  <CardContent className="p-6 text-center">
                    <Gift className="h-8 w-8 text-teal-400 mx-auto mb-3" />
                    <h3 className="font-bold text-white mb-2">Reward</h3>
                    <p className="text-sm text-gray-300">$150 worth</p>
                    <p className="text-sm text-teal-400">USDT</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">1 Hour Each</p>
                    <p className="text-sm text-blue-400">3 Seasons</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-blue-500/30 animate-slideInUp">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Node Discussion for <span className="text-blue-400 font-bold">BluWhale</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      ...
                      season, the host will give a different task and after the task share on group, user can prepare the
                      correct answer.
                    </p>
                    <p>
                    ...
                    <p className="text-lg font-bold text-blue-400">
                      15 total winners to get $10 each in USDT.
                    </p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-red-500/10 to-blue-500/10 border border-red-500/30 rounded-lg p-6">
                  <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-cyan-400 font-mono">#NodeBluWhale</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                            ...
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-blue-500 ml-4">
                                  ...
                                  <p className="text-blue-400 font-mono">Hashtag #NodeBluWhale</p>
                                </div>
                              </>
                            )}
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-cyan-500 ml-4">
                                  ...
                                  <p className="text-cyan-400 font-mono">Hashtag #NodeBluWhale</p>
                                </div>
                              </>
                            )}
                            {round.id === 3 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-teal-500 ml-4">
                                  ...
                                  <p className="text-teal-400 font-mono">Hashtag #NodeBluWhale</p>
                                </div>
                              </>
                            )}
                          </div>
                      ...
                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-blue-500/30 animate-float">
                          <img
                            ...
                            alt={`Season ${round.id} - ${round.title}`}
