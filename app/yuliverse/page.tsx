  ...
  const rounds = [
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598798/yuliverse1_zuq36i.jpg",
      winners: 5,
      description: "Answer the correct choice questions to win $10 in $YULI tokens",
        ...
        },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598799/yuliverse2_nfertr.jpg",
      winners: 5,
        ...
        },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598800/yuliverse3_utuaiz.jpg",
      winners: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/ncbsx8go/image/upload/v1785598798/yuliverse4_voqit3.jpg",
      winners: 5,
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% { box-shadow: 0 0 40px rgba(6, 182, 212, 0.8), 0 0 60px rgba(6, 182, 212, 0.6); }
        }
        @keyframes slideInUp {
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 mb-6">
                <img src="/L2E - 15.png" alt="Yuliverse" className="h-20 w-auto rounded-lg animate-float" />
              </div>

              <h1 className="text-3xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                Learn To Earn
              </h1>
              ...
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">By Muhamad Novreysa • January 15, 2025</p>
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-300">January 18, 2025</p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-purple-400">$YULI Tokens</p>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-cyan-500/30 animate-slideInUp">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-gray-300">
                  Welcome to our Learn To Earn session for <span className="text-cyan-400 font-bold">YULIVERSE</span>!
                </p>
                ...
                <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-justify">
                    <p>
                      There will be a total of <span className="text-cyan-400 font-bold">4 rounds</span>. In each round,
                      the host will give a different task and after the task share on group, user can prepare the
                      correct answer.
                    </p>
                    <p>Once unmuted group, the user can answer. 20 total winners to get $10 each in $YULI.</p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3 text-gray-300 text-justify">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <span className="text-cyan-400 font-mono">#L2EYuliverse</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-12 max-w-6xl mx-auto">
              {rounds.map((round, index) => (
                <Card
                  key={round.id}
                  className={`bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-cyan-500/30 overflow-hidden animate-slideInUp`}
                ...
                >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mt-2">
                            ...
                            <span className="text-green-400 text-sm">$10 each in $YULI</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-gray-300">
                            {round.id === 1 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-cyan-500 ml-4">
                                  ...
                                  <p className="text-cyan-400 font-mono">Hashtag #L2EYuliverse</p>
                                </div>
                            ...
                            {round.id === 2 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-blue-500 ml-4">
                                  ...
                                  <p className="text-blue-400 font-mono">Hashtag #L2EYuliverse</p>
                                </div>
                                <p>3️⃣ Give a reaction to each question</p>
                              </>
                            )}
                            {round.id === 3 && (
                              <>
                                ...
                                <div className="bg-gray-800/50 p-3 rounded border-l-4 border-purple-500 ml-4">
                                  ...
                                  <p className="text-purple-400 font-mono">Hashtag #L2EYuliverse</p>
                                </div>
                                <p>3️⃣ Give a reaction to each question</p>
                              </>
                            )}
                            {round.id === 4 && (
                              <>
                                <p>1️⃣ Check out the Tokenomics on the Whitepaper Yuliverse</p>
                                <p>
                                ...
                                <p>3️⃣ Put your Telegram Username and hashtag #L2EYuliverse on the RED BOX</p>
                              </>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="text-center">
                          <p className="text-lg font-bold text-green-400">
                            🎁 The winners are selected randomly by the team for $10 in $YULI!
                          </p>
                        </div>
                      </div>

                      <div className="relative">
                        <div className="relative overflow-hidden rounded-xl border border-cyan-500/30 animate-float">
                          <img
                    ...
                    {round.id === 4 && (
                      <div className="mt-8 space-y-4">
                        <h4 className="text-xl font-bold text-white mb-4">The Question:</h4>
                        <Card className="bg-gray-800/50 border-gray-600/30 p-6 text-center">
                          <div className="w-full h-64 bg-gray-700/50 rounded border-2 border-dashed border-gray-600 overflow-hidden">
                            <div className="w-full h-full flex items-center justify-center">
                              <p className="text-gray-500">Tokenomics Chart - Coming Soon</p>
                            </div>
                          </div>
                        </Card>
                      </div>
        ...
        <footer className="py-12 px-4 border-t border-cyan-500/20">
          <div className="container mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/L2E - 15.png" alt="Yuliverse" className="h-8 w-8 rounded" />
